 ...
 * @export
 */
export type IssuedProductServicingData =
  | ({ productType: "INVOICE_FINANCING" } & InvoiceFinancingServicingData)
  | ({ productType: "LINE_OF_CREDIT" } & LineOfCreditServicingData)
  | ({ productType: "MCA" } & McaServicingData)
  | ({ productType: "TERM_LOAN" } & TermLoanServicingData);

export function IssuedProductServicingDataFromJSON(
  json: any
): IssuedProductServicingData {
  return IssuedProductServicingDataFromJSONTyped(json, false);
}

export function IssuedProductServicingDataFromJSONTyped(
  json: any,
  ...
  switch (json["productType"]) {
    case "INVOICE_FINANCING":
      return Object.assign(
        {},
        InvoiceFinancingServicingDataFromJSONTyped(json, true),
        { productType: "INVOICE_FINANCING" }
      );
    case "LINE_OF_CREDIT":
      return Object.assign(
        {},
        LineOfCreditServicingDataFromJSONTyped(json, true),
        { productType: "LINE_OF_CREDIT" }
      );
    case "MCA":
      return Object.assign({}, McaServicingDataFromJSONTyped(json, true), {
        productType: "MCA",
      });
    case "TERM_LOAN":
      return Object.assign({}, TermLoanServicingDataFromJSONTyped(json, true), {
        productType: "TERM_LOAN",
      });
    default:
      throw new Error(
        `No variant of IssuedProductServicingData exists with 'productType=${json["productType"]}'`
      );
  }
}

export function IssuedProductServicingDataToJSON(
  value?: IssuedProductServicingData | null
): any {
  if (value == null) {
    return value;
  }
  switch (value["productType"]) {
    ...
    default:
      throw new Error(
        `No variant of IssuedProductServicingData exists with 'productType=${value["productType"]}'`
      );
  }
}
