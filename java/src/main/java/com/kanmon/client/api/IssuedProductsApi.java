...
public class IssuedProductsApi {
     ...
     */
    public okhttp3.Call getIssuedProductsCall(String ids, String platformBusinessIds, String businessIds, BigDecimal offset, BigDecimal limit, String createdAtStart, String createdAtEnd, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIssuedProductsValidateBeforeCall(String ids, String platformBusinessIds, String businessIds, BigDecimal offset, BigDecimal limit, String createdAtStart, String createdAtEnd, final ApiCallback _callback) throws ApiException {
        return getIssuedProductsCall(ids, platformBusinessIds, businessIds, offset, limit, createdAtStart, createdAtEnd, _callback);
     ...
     */
    public GetIssuedProductsResponse getIssuedProducts(String ids, String platformBusinessIds, String businessIds, BigDecimal offset, BigDecimal limit, String createdAtStart, String createdAtEnd) throws ApiException {
        ApiResponse<GetIssuedProductsResponse> localVarResp = getIssuedProductsWithHttpInfo(ids, platformBusinessIds, businessIds, offset, limit, createdAtStart, createdAtEnd);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetIssuedProductsResponse> getIssuedProductsWithHttpInfo(String ids, String platformBusinessIds, String businessIds, BigDecimal offset, BigDecimal limit, String createdAtStart, String createdAtEnd) throws ApiException {
        okhttp3.Call localVarCall = getIssuedProductsValidateBeforeCall(ids, platformBusinessIds, businessIds, offset, limit, createdAtStart, createdAtEnd, null);
     ...
     */
    public okhttp3.Call getIssuedProductsAsync(String ids, String platformBusinessIds, String businessIds, BigDecimal offset, BigDecimal limit, String createdAtStart, String createdAtEnd, final ApiCallback<GetIssuedProductsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIssuedProductsValidateBeforeCall(ids, platformBusinessIds, businessIds, offset, limit, createdAtStart, createdAtEnd, _callback);
        Type localVarReturnType = new TypeToken<GetIssuedProductsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
