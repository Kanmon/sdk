...
public class JSON {
        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                .registerTypeSelector(com.kanmon.client.model.CreateSessionTokenRequestBodyData.class, new TypeSelector<com.kanmon.client.model.CreateSessionTokenRequestBodyData>() {
                    ...
                    public Class<? extends com.kanmon.client.model.CreateSessionTokenRequestBodyData> getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("SESSION_ACCOUNTS_PAYABLE_INVOICE_FLOW", com.kanmon.client.model.AccountsPayableInvoiceFlowSessionTokenData.class);
                        classByDiscriminatorValue.put("SESSION_ACCOUNTS_PAYABLE_INVOICE_FLOW_WITH_INVOICE_FILE", com.kanmon.client.model.AccountsPayableInvoiceFlowWithInvoiceFileSessionTokenData.class);
                        ...
                        classByDiscriminatorValue.put("AccountsPayableInvoiceFlowSessionTokenData", com.kanmon.client.model.AccountsPayableInvoiceFlowSessionTokenData.class);
                        classByDiscriminatorValue.put("AccountsPayableInvoiceFlowWithInvoiceFileSessionTokenData", com.kanmon.client.model.AccountsPayableInvoiceFlowWithInvoiceFileSessionTokenData.class);
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.AccountsPayableSessionInvoiceWithInvoiceFile.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.CreateIntegratedMcaReceivable400Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.CreateIntegratedMcaReceivable409Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.CreateIntegratedMcaReceivableBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.GetPaymentIntentsResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.NoRemainingBalanceException.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.PaymentIntent.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.kanmon.client.model.TooManyRequestsException.CustomTypeAdapterFactory());
