...
public class ConnectToken {
  ...
  public ConnectToken connectToken(String connectToken) {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("connectToken");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("connectToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `connectToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("connectToken").toString()));
      }
  }
