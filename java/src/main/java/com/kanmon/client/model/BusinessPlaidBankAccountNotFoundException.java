...
public class BusinessPlaidBankAccountNotFoundException {
  ...
  public BusinessPlaidBankAccountNotFoundException() {
  }

  public BusinessPlaidBankAccountNotFoundException errorCode(ErrorCodeEnum errorCode) {
  ...
  **/
  ...
  public BusinessPlaidBankAccountNotFoundException message(String message) {
  ...
  **/
  ...
  public BusinessPlaidBankAccountNotFoundException timestamp(String timestamp) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class BusinessPlaidBankAccountNotFoundException {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessPlaidBankAccountNotFoundException.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessPlaidBankAccountNotFoundException is not found in the empty JSON string", BusinessPlaidBankAccountNotFoundException.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessPlaidBankAccountNotFoundException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessPlaidBankAccountNotFoundException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessPlaidBankAccountNotFoundException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessPlaidBankAccountNotFoundException.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessPlaidBankAccountNotFoundException>() {
           @Override
