...
public class IncorrectProductTypeException {
  ...
  public IncorrectProductTypeException() {
  }

  public IncorrectProductTypeException errorCode(ErrorCodeEnum errorCode) {
  ...
  **/
  ...
  public IncorrectProductTypeException message(String message) {
  ...
  **/
  ...
  public IncorrectProductTypeException timestamp(String timestamp) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class IncorrectProductTypeException {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IncorrectProductTypeException.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncorrectProductTypeException is not found in the empty JSON string", IncorrectProductTypeException.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncorrectProductTypeException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncorrectProductTypeException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncorrectProductTypeException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncorrectProductTypeException.class));

       return (TypeAdapter<T>) new TypeAdapter<IncorrectProductTypeException>() {
           @Override
