...
public class ForbiddenException {
  ...
  public ForbiddenException errorCode(ErrorCodeEnum errorCode) {
  ...
  **/
  ...
  public ForbiddenException message(String message) {
  ...
  **/
  ...
  public ForbiddenException timestamp(String timestamp) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ForbiddenException {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ForbiddenException
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForbiddenException.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForbiddenException is not found in the empty JSON string", ForbiddenException.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForbiddenException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForbiddenException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForbiddenException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForbiddenException.class));

       return (TypeAdapter<T>) new TypeAdapter<ForbiddenException>() {
           @Override
 ...
 /**
  * Create an instance of ForbiddenException given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ForbiddenException
  * @throws IOException if the JSON string is invalid with respect to ForbiddenException
  */
  public static ForbiddenException fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForbiddenException.class);
  }

 /**
  * Convert an instance of ForbiddenException to an JSON string
  *
  * @return JSON string
  */
