...
public class EmbeddedSession {
  ...
  public EmbeddedSession sessionToken(String sessionToken) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmbeddedSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmbeddedSession is not found in the empty JSON string", EmbeddedSession.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmbeddedSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmbeddedSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmbeddedSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmbeddedSession.class));

       return (TypeAdapter<T>) new TypeAdapter<EmbeddedSession>() {
           @Override
