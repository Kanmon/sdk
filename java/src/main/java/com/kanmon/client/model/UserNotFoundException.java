...
public class UserNotFoundException {
  ...
  public UserNotFoundException errorCode(ErrorCodeEnum errorCode) {
  ...
  **/
  ...
  public UserNotFoundException message(String message) {
  ...
  **/
  ...
  public UserNotFoundException timestamp(String timestamp) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserNotFoundException
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserNotFoundException.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserNotFoundException is not found in the empty JSON string", UserNotFoundException.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserNotFoundException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserNotFoundException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserNotFoundException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserNotFoundException.class));

       return (TypeAdapter<T>) new TypeAdapter<UserNotFoundException>() {
           @Override
 ...
 /**
  * Create an instance of UserNotFoundException given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserNotFoundException
  * @throws IOException if the JSON string is invalid with respect to UserNotFoundException
  */
  public static UserNotFoundException fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserNotFoundException.class);
  }

 /**
  * Convert an instance of UserNotFoundException to an JSON string
  *
  * @return JSON string
  */
